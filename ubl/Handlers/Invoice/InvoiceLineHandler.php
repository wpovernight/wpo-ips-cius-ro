...
namespace WPO\IPS\CIUS_RO\Handlers\Invoice;
...
class InvoiceLineHandler extends UblHandler {
	...
	public function handle( $data, $options = array() ) {
		...
		foreach ( $items as $item_id => $item ) {
			...
			$invoiceLine['value'][] = apply_filters( 'wpo_ips_cius_ro_handle_InvoiceLineItem', $invoiceLineItem, $data, $options, $item, $this );
			$invoiceLine['value'][] = apply_filters( 'wpo_ips_cius_ro_handle_InvoiceLinePrice', $invoiceLinePrice, $data, $options, $item, $this );
			$data[]                 = apply_filters( 'wpo_ips_cius_ro_handle_InvoiceLine', $invoiceLine, $data, $options, $item, $this );
		}
